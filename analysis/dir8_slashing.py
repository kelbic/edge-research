...
на ВСЁМ мейннете; из них 2 теста «slash 10%», 10 — рекламный само-слэшинг
(desc='👉 eigenyields.xyz/vaults'), 2 пустых desc, 1 'AlephAVS redistributable
slash'. Реальных фолтов ≈ 0-3. Контекст: 99 operator-sets, slasher настроен у 21,
redistribution у 14.
